// ============================================================
// src/pages/Home.jsx — Página principal con animaciones
// ============================================================
...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const onScroll = () => {
            ...
            const imgs = hero.querySelectorAll('.carousel-img')
            imgs.forEach(img => {
                img.style.transform = `translateY(${scrolled * 0.18}px)`
            })
        }
        ...
        <main>
            ...
            <section className="section how-it-works">
                <div className="container">
                    <h2 className="section-title reveal" data-delay="0">¿Cómo funciona?</h2>
                    <p className="section-sub reveal" data-delay="80">De tu idea a tu puerta en 4 pasos simples</p>
                    <div className="steps-grid">

                        <div className="step-card reveal" data-delay="0">
                        ...
                        <div className="step-card reveal" data-delay="110">
                        ...
                        <div className="step-card reveal" data-delay="220">
                        ...
                        <div className="step-card reveal" data-delay="330">
            ...
            <section className="section mas-vendidos">
                <div className="container">
                    <div className="mas-vendidos__header">
                        <div>
                            <h2 className="section-title reveal" data-delay="0" style={{ textAlign: 'left', marginBottom: 4, display: 'flex', alignItems: 'center', gap: '10px' }}>
                                <svg viewBox="0 0 24 24" fill="none" stroke="var(--color-wine)" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" style={{ width: 28, height: 28, flexShrink: 0 }}>
                                    <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z" />
                                </svg>
                                Más Vendidos
                            </h2>
                            <p className="section-sub reveal" data-delay="80" style={{ textAlign: 'left', marginBottom: 0 }}>Los favoritos de nuestra comunidad</p>
                        </div>
                    ...
                    <div className="mas-vendidos__grid">
                        {masVendidos.map((producto, idx) => (
                            <div key={producto.id} className="mas-vendidos__item reveal" data-delay={idx * 100}>
            ...
            {selectedProduct && (
                <ProductCustomizer producto={selectedProduct} onClose={() => setSelectedProduct(null)} />
            )}

            {/* ── ¿Qué hacemos? ── */}
            <section className="section home-features">
                <div className="container">
                    <h2 className="section-title reveal" data-delay="0">¿Qué hacemos?</h2>
                    <p className="section-sub reveal" data-delay="80">Fabricamos productos, personalizados y con amor por el detalle</p>
                    <div className="features-grid">

                        <div className="feature-card card reveal-icon" data-delay="0">
                        ...
                        <div className="feature-card card reveal-icon" data-delay="110">
                            <span className="feature-icon">
                                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="feature-card card reveal-icon" data-delay="220">
                            <span className="feature-icon">
                                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="feature-card card reveal-icon" data-delay="330">
                            <span className="feature-icon">
            ...
            <section className="home-cta">
                <div className="container">
                    <div className="home-cta__inner reveal" data-delay="0">
                        <h2>¿Listo/a para diseñar tu pieza?</h2>
                        <p>Explora el catálogo y personaliza lo que quieras</p>
                        <Link to="/catalogo" className="btn btn-primary btn-shimmer">Ver catálogo</Link>
                    </div>
                </div>
            </section>
        </main>
