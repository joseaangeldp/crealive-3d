        ...
        <main>
            ...
            <section className="section how-it-works">
                <div className="container">
                    ...
                    <p className="section-sub reveal" data-delay="120">De tu idea a tu puerta en 4 pasos simples</p>
                    <div className="steps-grid">
                        ...
                        <div className="step-card reveal" data-delay="180">
                        ...
                        <div className="step-card reveal" data-delay="360">
                        ...
                        <div className="step-card reveal" data-delay="540">
                ...
                <div className="container">
                    <div className="mas-vendidos__header">
                        <div>
                            ...
                            <p className="section-sub reveal" data-delay="120" style={{ textAlign: 'left', marginBottom: 0 }}>Los favoritos de nuestra comunidad</p>
                        </div>
            ...
            <section className="section home-features">
                <div className="container">
                    ...
                    <p className="section-sub reveal" data-delay="120">Fabricamos productos, personalizados y con amor por el detalle</p>
                    <div className="features-grid">
                        ...
                        <div className="feature-card card reveal-icon" data-delay="180">
                            <span className="feature-icon">
                                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="feature-card card reveal-icon" data-delay="360">
                            <span className="feature-icon">
                                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="feature-card card reveal-icon" data-delay="540">
                            <span className="feature-icon">
