...
export default function AdminOrders() {
    ...
    // Nota: la notificación por email al cliente se eliminó a propósito —
    // enviaba con una API key expuesta en el bundle. Si se retoma, va
    // server-side (Edge Function), nunca desde el navegador.
    ...
    // El link público usa public_token (uuid aleatorio), nunca el id interno
